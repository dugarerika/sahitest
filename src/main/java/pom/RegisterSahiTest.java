...
public class RegisterSahiTest {
    ...
    public RegisterSahiTest fillForm(String strUserName, String strPassword, String addr, String billaddr, String state){
        Utilities.el(LNKREG);
    ...
    public RegisterSahiTest btnRegister(){
        Utilities.click(BTNREGISTER);
        return this;
    }
    public RegisterSahiTest btnCancel(){
        Utilities.click(BTNCANCEL);
        return this;
    }

    public RegisterSahiTest lnkbckToLogin(){
